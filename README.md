...
- [Dil3mm4](https://forum.xda-developers.com/member.php?u=9034316) for his version of LineageOS where the initial v1 files belonged to
- [haky86](https://forum.xda-developers.com/member.php?u=4883214) for his version of AOSiP where the current v1 files belong to
- [kountry83](https://forum.xda-developers.com/member.php?u=3756725) for his Pie NFC fix and where the v2 and v3 files belong to
